...
import { Plus, DollarSign, AlertCircle, X, History, ArrowRight, NotebookPen } from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto space-y-8 pb-24 relative min-h-[80vh]">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {expenses.length === 0 ? (
                            <div className="col-span-full py-24 flex flex-col items-center justify-center border-2 border-dashed dark:border-gray-800 rounded-[2rem] bg-gray-50/50 dark:bg-gray-900/20">
                            ...
                            expenses.map(exp => (
                                <div key={exp.id} className="group relative bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all">
                                    <div className="flex items-center justify-between mb-5">
                                        <div className="h-12 w-12 bg-red-50 dark:bg-red-900/10 rounded-2xl flex items-center justify-center text-red-600">
                                            <NotebookPen size={24} />
                                        </div>
                                        <div className="flex flex-col items-end text-right">
                                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">Expense Date</span>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <div className="font-extrabold text-lg text-gray-900 dark:text-gray-100 line-clamp-2 min-h-[3.5rem]">{exp.description}</div>
                                        </div>

                                        <div className="pt-4 border-t dark:border-gray-800 flex justify-between items-center bg-red-50/30 dark:bg-red-900/10 -mx-6 -mb-6 px-6 py-4 rounded-b-3xl">
                                            <span className="text-[10px] font-black uppercase text-gray-400 tracking-widest">Amount</span>
                                            <span className="text-xl font-black text-red-600 font-mono">${Number(exp.amount).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                                        </div>
                                    </div>
                                </div>
                            ))
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-3">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-14 px-6 bg-gray-50 dark:bg-gray-800 border-2 dark:border-gray-800 rounded-2xl outline-none focus:border-red-600/50 font-black"
                                        />
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full p-5 bg-gray-50 dark:bg-gray-800 border-2 dark:border-gray-800 rounded-2xl outline-none focus:border-red-600/50 font-medium transition-all"
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full h-16 pl-14 pr-6 bg-gray-50 dark:bg-gray-800 border-2 dark:border-gray-800 rounded-2xl outline-none focus:border-red-600/50 font-black text-2xl text-red-600 transition-all"
                                                placeholder="0.00"
                                            />
                                        </div>
                                    </div>
