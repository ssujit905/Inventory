        ...
        <div className="flex flex-col h-screen w-full bg-gray-50 dark:bg-gray-950 font-sans text-gray-900 dark:text-gray-100 overflow-hidden">
            ...
            <header className="h-16 flex-shrink-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 sticky top-0 z-30">
                ...
                <div className="flex items-center gap-2.5">
                    <img src="/logo.png" alt="Shopy Nepal" className="h-8 w-auto object-contain" onError={(e: any) => { e.target.style.display = 'none'; }} />
                    <span className="text-base font-black tracking-tight text-gray-900 dark:text-gray-100">Shopy Nepal <span className="text-primary text-xs uppercase px-1.5 py-0.5 bg-primary/10 rounded-md ml-1 font-bold">Vendor</span></span>
                </div>
                ...
                <div className="px-5 pt-3 pb-2 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
                    <div className="relative max-w-md mx-auto">
                        ...
                        <input
                            ...
                            onKeyDown={(e) => {
                                if (e.key === 'Enter') {
                                    const route = location.pathname === '/admin/inventory' ? location.pathname : '/admin/inventory';
                                    navigate(route);
                                    setIsSearchOpen(false);
                                    setShowSuggestions(false);
                                }
            ...
            {isMenuOpen && (
                <div className="fixed inset-0 z-[100] bg-white dark:bg-gray-950 flex flex-col animate-in slide-in-from-right duration-300">
                    <div className="h-16 flex items-center justify-between px-6 border-b border-gray-100 dark:border-gray-800">
                        <div className="flex items-center gap-2">
                            <img src="/logo.png" alt="Shopy Nepal" className="h-7 w-auto object-contain" />
                            <span className="text-base font-black">Vendor Portal</span>
                        </div>
                        ...
                        <section className="pt-6 border-t border-gray-100 dark:border-gray-900">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <LogOut size={20} />
                                    <span>Logout Vendor Account</span>
                                </div>
                    ...
                    <div className="p-8 text-center bg-gray-50 dark:bg-gray-900/50">
                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest">Shopy Nepal Vendor v1.0.0</p>
                    </div>
                </div>
            )}
        </div>
