                            ...
                            {group.keys.map(field => (
                                <div key={field.key} className="space-y-1.5">
                                    ...
                                    {field.key.includes('image') ? (
                                        ...
                                        <select
                                            value={settings[field.key] || 'test'}
                                            onChange={e => update(field.key, e.target.value)}
                                            className="w-full h-11 px-4 rounded-xl border border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 text-xs font-bold focus:border-primary/30 outline-none transition-all cursor-pointer"
                                        >
                                        ...
                                        <input
                                            ...
                                            onChange={e => update(field.key, e.target.value)}
                                            placeholder={field.placeholder}
                                            className="w-full h-11 px-4 rounded-xl border border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 text-xs font-mono font-bold focus:border-primary/30 outline-none transition-all"
                                        />
