                            ...
                            <div key={customer.phone} className="bg-white dark:bg-gray-900 p-5 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100/50 dark:border-white/5">
                                        ...
                                        <p className="text-sm font-black text-gray-400 flex items-center gap-1.5"><Key size={14} /> PIN protected</p>
                                    </div>
                                </div>
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-3 pt-2">
                                <button
                                    ...
                                    className="w-full py-4 bg-gray-900 dark:bg-gray-700 text-white font-black rounded-3xl flex items-center justify-center gap-3 active:scale-95 disabled:opacity-50 transition-all uppercase text-xs tracking-widest"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full py-5 bg-primary text-white font-black rounded-3xl shadow-xl shadow-primary/20 flex items-center justify-center gap-3 active:scale-95 disabled:opacity-50 transition-all uppercase text-xs tracking-widest"
                                >
