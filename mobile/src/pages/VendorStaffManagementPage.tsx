...
export default function VendorStaffManagementPage() {
    ...
    return (
        <DashboardLayout role="staff">
            {toast && (
                <div className={`fixed top-8 right-8 z-[200] flex items-center gap-3 px-6 py-4 rounded-3xl shadow-2xl text-white text-[11px] font-black uppercase tracking-widest ${toast.type === 'success' ? 'bg-emerald-500' : 'bg-rose-500'}`}>
            ...
            {isAddModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-5 bg-gray-950/80 backdrop-blur-xl">
                    <div className="bg-white dark:bg-gray-900 w-full max-w-lg rounded-[2rem] overflow-hidden border border-white/10 max-h-[90vh] flex flex-col">
            ...
            {confirmDelete && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-5 bg-gray-950/80 backdrop-blur-xl">
                    <div className="bg-white dark:bg-gray-900 w-full max-w-sm rounded-[2rem] overflow-hidden border border-white/10">
